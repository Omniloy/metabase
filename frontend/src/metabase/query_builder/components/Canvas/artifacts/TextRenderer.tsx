...
export function TextRenderer(props: TextRendererProps) {
  ...
  return (
    <div style={{ width: "100%", height: "100%", marginTop: "2rem", display: "flex", flexDirection: "column", borderTop: "1px solid #e5e7eb", overflowY: "auto", padding: "0.5rem" }}
    //  className="w-full h-full mt-2 flex flex-col border-t-[1px] border-gray-200 overflow-y-auto py-5"
     >
      {/* <style jsx global>{`

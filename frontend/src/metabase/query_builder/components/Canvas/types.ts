...
export interface ArtifactV3 {
  currentIndex: number;
  contents: (ArtifactMarkdownV3 | ArtifactCodeV3 | ArtifactQueryV3 | ArtifactInsightsV3)[];
}
...
export interface ArtifactQueryV3 {
  index: number;
  type: "card";
  title: string;
  cardId: any;
...
export interface ArtifactImageV3 {
  index: number;
  type: "image";
  title: string;
  image: any;
...
export interface ArtifactInsightsV3 {
  index: number;
  type: "insight";
  title: string;
  insight: any;
...
export interface ArtifactToolResponse {
  ...
  language?: string;
  type?: string;
  card_id?: number; // For query artifacts
  query_result?: Record<string, any>[]; // Result of the query execution
}
